function [ L_t,R2,R2_s,Gamma_k,sigma2_mu ] = modified_Kmean( V_t, K,b,lambda )
...
%              The vector must have C x T dimension, where C is the number
%              of channels and T is the temporal dimension.
%         K:   number of cluster the algorithm is supposed to look for.
%                    b:          window size hyper-parameter
%           lambda:    smoothn. penalty hyper-parameter
